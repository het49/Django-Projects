...
class CustomValidationError(BadRequest):
    """Exception used on validation fail on api view.
    """
    default_detail = _('Invalid input.')
    default_code = 'invalid'


class LoginTimeOutError(exceptions.APIException):
    """Exception used on session expired on api view.
    """
    status_code = 440
    default_detail = _('Session has expired and must log in again.')
